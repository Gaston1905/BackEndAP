...
public class Education implements Serializable {
    ...
    @Column(length = 500, name = "name_edu", nullable = false)
    ...
    public Education(Long idEdu, String titleEdu, LocalDate startDateEdu, LocalDate endDateEdu, String picEdu, String nameEdu) {
        this.idEdu = idEdu;
    ...
    public void setDescEdu(String nameEdu) {
        this.nameEdu = nameEdu;
    }
